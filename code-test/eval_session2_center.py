...
from dataset_info_session2_center import *
from utils import *
from loading import *
...
#%%
DEFAULT_CONFIG = "config_session2_center.py"
...
if __name__ == "__main__":
    ...
    RESULTS_CACHE_FILE = os.path.join(RESULTS_DIR, "resultsCache_session2_center_%s.pkl"%MEASUREMENT_MODE)
