...
#RUN_FOR_SYSTEMS = ( "session2_right-evalblobtracks", )
#RUN_FOR_SYSTEMS = ( "session2_right-evalopticalflowtracks", )

#RUN_FOR_SYSTEMS = ( "session2_right-evalblobtracks-10000frames-ptClosestToCam", )
#RUN_FOR_SYSTEMS = ( "session2_right-evalblobtracks-10000frames-plp-on-rects", )
#RUN_FOR_SYSTEMS = ( "session2_right-evalblobtracks-10000frames-re-H-est", )
#RUN_FOR_SYSTEMS = ( "session2_right-evalblobtracks-10000frames-bottom-ctr-of-BB", )
#RUN_FOR_SYSTEMS = ( "session2_right-evalblobtracks-10000frames-no-MPI", )
#RUN_FOR_SYSTEMS = ( "session2_right-evalblobtracks-all-frames-no-MPI", )
#RUN_FOR_SYSTEMS = ( "session2_right-evalblobtracks-10000frames-3MPI", )

#RUN_FOR_SYSTEMS = ( "session2_right-evalopticalflowtracks-10000frames-plp-on-rects", )
#RUN_FOR_SYSTEMS = ( "session2_right-evalopticalflowtracks-10000frames-ptClosestToCam", )
#RUN_FOR_SYSTEMS = ( "session2_right-evalopticalflowtracks-10000frames-re-H-est", )
#RUN_FOR_SYSTEMS = ( "session2_right-evalopticalflowtracks-10000frames-bottom-ctr-of-BB", )
#RUN_FOR_SYSTEMS = ( "session2_right-evalopticalflowtracks-10000frames-no-MPI", )
#RUN_FOR_SYSTEMS = ( "session2_right-evalopticalflowtracks-all-frames-no-MPI", )
#RUN_FOR_SYSTEMS = ( "session2_right-evalopticalflowtracks-10000frames-3MPI", )
