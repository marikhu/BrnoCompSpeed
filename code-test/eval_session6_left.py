...
from dataset_info_session6_left import *
from utils import *
from loading import *
...
#%%
DEFAULT_CONFIG = "config_session6_left.py"
...
if __name__ == "__main__":
    ...
    RESULTS_CACHE_FILE = os.path.join(RESULTS_DIR, "resultsCache_session6_left_%s.pkl"%MEASUREMENT_MODE)
