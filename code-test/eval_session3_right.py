...
from dataset_info_session3_right import *
from utils import *
from loading import *
...
#%%
DEFAULT_CONFIG = "config_session3_right.py"
...
if __name__ == "__main__":
    ...
    RESULTS_CACHE_FILE = os.path.join(RESULTS_DIR, "resultsCache_session3_right_%s.pkl"%MEASUREMENT_MODE)
