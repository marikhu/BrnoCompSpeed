...
#RUN_FOR_SYSTEMS = ( "session4_left-evalblobtracks-10000frames-no-MPI", )
#RUN_FOR_SYSTEMS = ( "session4_left-evalblobtracks-all-frames-no-MPI", )
RUN_FOR_SYSTEMS = ( "session4_left-evalblobtracks-10000frames-3MPI", )
